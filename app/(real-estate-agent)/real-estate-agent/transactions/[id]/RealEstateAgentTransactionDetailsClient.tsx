...
interface RealEstateAgentTransactionDetailsClientProps {
  id: string;
}

export default function RealEstateAgentTransactionDetailsClient({
  id: transactionId,
}: RealEstateAgentTransactionDetailsClientProps) {
  const { agentUser } = useRealEstateAgentAuth();
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6">
      <TransactionHeader
        ...
        backLink="/real-estate-agent/transactions"
      ...
      {/* Tabs Container - Main content area */}
