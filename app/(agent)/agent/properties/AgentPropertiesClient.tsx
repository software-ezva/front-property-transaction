    ...
    <DashboardLayout user={agentUserForHeader}>
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <h1 className="text-3xl font-bold text-foreground font-primary">Properties</h1>
            <p className="text-muted-foreground font-secondary">Manage your property portfolio and listings</p>
          </div>
        ...
        <div className="space-y-4">
          {filteredProperties.length > 0 ? (
            ...
            <div className="bg-card rounded-lg p-12 border border-border text-center">
              ...
              <p className="text-muted-foreground mb-4">No properties match your current search criteria.</p>
              <Button
                onClick={() => {
                  setSearchTerm("")
                  setStatusFilter("all")
