...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = "primary", size = "md", children, asChild = false, ...props }, ref) => {
    ...
    const variants = {
      ...
      tertiary: "bg-tertiary text-tertiary-foreground hover:bg-tertiary/90 shadow-sm hover:shadow-md",
      outline: "border border-border bg-card hover:bg-accent hover:text-accent-foreground shadow-sm hover:shadow-md",
